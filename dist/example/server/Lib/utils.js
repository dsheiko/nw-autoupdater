const fs = require("fs"),
      ...
      platforms = [[`linux-x64.`, `linux64`], [`linux-x32.`, `linux32`], [`osx-x64.`, `mac64`], [`osx-x32.`, `mac32`], [`win-ia32.`, `win32`], [`win-x64.`, `win64`]];
...
function updateManifest(host, version = null) {
  fs.readdir(RELEASES, (err, files) => {
    ...
    fs.writeFile(MANIFEST_FILE, JSON.stringify(manifest, null, 2), "utf8", err => {
      ...
      console.log("package.json updated" + (version ? ` to version ${c.cyan(version)}` : ""));
    });
  });
}
